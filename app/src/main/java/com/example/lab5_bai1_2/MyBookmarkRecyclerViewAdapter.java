...
import com.example.lab5_bai1_2.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.lab5_bai1_2.databinding.FragmentBookmarkBinding;
...
public class MyBookmarkRecyclerViewAdapter extends RecyclerView.Adapter<MyBookmarkRecyclerViewAdapter.ViewHolder> {
    ...
    public MyBookmarkRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
